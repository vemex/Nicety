...
/*开发目录配置*/
moduleExports.appDir = path.resolve(moduleExports.rootDir, './app'); // 应用程序开发目录
...
// 生成文件目录
moduleExports.runDir = path.resolve(moduleExports.rootDir, './target/www'); // webpack 测试运行目录
moduleExports.buildDir = path.resolve(moduleExports.rootDir, './target/dist'); // webpack 构建输出目录
