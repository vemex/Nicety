<template>
    <div :class="['nicety select tree-select', {'multiple': multiple}]"
         @click="clickHandler"
        ...
        <div class="content" v-show="visible" @click.stop="()=>{}">
            <nicety-tree
                    ...
                    @item-checked="itemCheckedHandler"></nicety-tree>
        </div>
    </div>
</template>
<script>
    ...
    import NicetyTree from './Tree.vue'
    export default {
        components: {NicetyTree},
        name: 'nicety-tree-select',
