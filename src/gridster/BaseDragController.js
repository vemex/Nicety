...
let applyDraggableLayoytInfo = function (info) {
    ...
    DomUtils.setPosition(info.el, postion);
    this._gridster._moveController._mirrorPosition = postion;
    ...
    constructor(gridster) {
        ...
        gridster._layoutManager.subscribe(function (infos) {
            if (_._gridster._onDragging) {//当处于拖拽状态时财之用
                applyDraggableLayoytInfo.call(_, infos);
            }
        });
